...
# export GITHUB_ORGANIZATION="YOUR_GITHUB_ORGANIZATION_OR_USERNAME"     # do not set this if you forked into your personal GitHub account
...
export DATALAD_GITHUB_TOKEN="GITHUB_PAT"                                # GitHub account > Settings > Developer Settings > Personal Access Tokens
